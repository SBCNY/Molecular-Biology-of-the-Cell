...
#Launch MBC PathNet in regular mode and add one gene into the 'Gene list' text box (e.g., AAK1). 
#Press the 'Add dataset'-button. If needed, change the parameter settings
