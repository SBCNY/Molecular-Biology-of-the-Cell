...
<br>
June 02, 2025
-	We added the new menu ‘Ontologies / Species’ that allows selection of 11 species for the 8 ontologies (/ontology namespaces). If gene-pathway annotations do not exist for a species of interest, the application will map human gene-pathway annotations to the species of interest using NCBI and, if available, MGI orthologues.
