...
- If SCPs of interest are selected, the user can now define significance criteria for the heatmap. Significant -log10(p-values) or ranks will be in red or blue, not significant in white.
