...
-	(We also changed the parameter organization, so that parameters related to node sizes will not be read from saved parameter settings generated with previous versions of the application.) 
