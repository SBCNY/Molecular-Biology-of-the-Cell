...
Follow the instructions in the 'CommandLine_Automation_Guide'-file to start the application from the command line skipping any interaction with the user-interface.<br>
<br>
