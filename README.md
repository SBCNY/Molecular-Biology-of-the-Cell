...
The subfolders "MBCO_windows_application" and "MBCO_linux_application" also contains <b><i><u>MBCO version 1.1</u></i></b> (that contains a reference for each pathway-gene association and was uploaded in February 2022).<br>
...
To start the Linux application, download the 'mono-xsp4' packaged from 'www.mono-project.com' ("an open source implementation of Microsoft's .NET Framework") and open the application from the terminal with the command "mono Molecular_Biology_of_the_Cell_Ontology.exe".<br>
<br>
