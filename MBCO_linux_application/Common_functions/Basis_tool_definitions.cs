...
namespace Common_functions.Form_tools
{
    ...
    class Form1_default_settings_class
    {
        ...
        public float Max_fontSize_defaultBold { get; private set; }
        ...
        private bool Allow_different_color_schemes { get; set; }
        ...
        {
            Allow_different_color_schemes = false;
            ...
            this.Current_width_min_percentage = 10;
            this.Current_width_max_percentage = 150;
            this.Current_height_min_percentage = 10;
            this.Current_height_max_percentage = 150;
        ...
        private void Fill_color_theme_listBox_and_width_height_textBoxes()
        {
            ...
            this.ColorTheme_listBox.Visible = Allow_different_color_schemes;
            this.ColorTheme_label.Visible= Allow_different_color_schemes;
        ...
        public void Update_all_graphic_elements_in_applicationSize_panel()
        {
            ...
            if (!Allow_different_color_schemes)
            {
                left_referenceBorder = right_referenceBorder;
        ...
        private void Set_colors_bright()
        {
            ...
            Color_label_backColor = Color.Transparent;
            ...
            ExplanationText_color = Color.DarkSlateGray;
        ...
        {
            int text_lines_count = text.Split('\n').Length;
        ...
        private Font Adjust_font_size_and_text_to_area_size(ref string text, Font font, out Size text_size, int width, int height, float max_fontSize)
        {
            text_size = new Size(0, 0);
            if (text.Length > 0)
            {
                text = text.Replace("\r\n", " ");
                int splitStrings_length = Math.Min(Resolution_parameter.Max_lines_per_label,text.Split(' ').Length);
                ...
                Font potential_font;
                for (int no_of_lines = 1; no_of_lines <= splitStrings_length; no_of_lines++)
                {
                    suggested_text = Split_text_equally_over_number_of_indicated_lines(text, no_of_lines);
        ...
        private Button Adjust_font_size_to_button_size(Button button)
        {
            ...
            button.Font = Adjust_font_size_and_text_to_area_size(ref text, button.Font, out size, button_text_area_width, button_text_area_height, max_fontSize);
        ...
        {
            int left_postion = left_referenceBorder + Resolution_parameter.CheckBoxButton_X_distance_from_referenceBorder;
            int width = right_refrenceBorder - Resolution_parameter.CheckBoxButton_X_distance_from_referenceBorder - left_postion;
            int top_postion = top_referenceBorder + Resolution_parameter.CheckBoxButton_Y_distance_from_referenceBorder;
            int height = bottom_referenceBorder - Resolution_parameter.CheckBoxButton_Y_distance_from_referenceBorder - top_postion;
            ...
            left_postion = left_referenceBorder + (int)Math.Round(0.5 * (right_refrenceBorder - left_referenceBorder - width));
            top_postion = top_referenceBorder + (int)Math.Round(0.5 * (bottom_referenceBorder - top_referenceBorder - height));
            my_cb_button.Location = new Point(left_postion, top_postion);
            my_cb_button.Text = "";
            return my_cb_button;
        }
        #endregion
        ...
        public Label LabelProgressReport_set_sizes_and_fontSize(Label my_label, int left0_middle1)
        {
            ...
            int bottom_position = top_position + (int)Math.Round(20*Resolution_parameter.Y_factor);
            ...
            my_label.Font = Adjust_font_size_and_text_to_area_size(ref text, my_label.Font, out size, width, height, 9999);
        ...
        private Label Label_adjust_fontSize_to_given_positions(Label label, int left_border_position, int right_border_position, int top_border_position, int bottom_border_position, float max_fontSize)
        {
            ...
            label.Font = Adjust_font_size_and_text_to_area_size(ref text, label.Font, out size, width, height, max_fontSize);
        ...
        {
            label = Default_set(label);
            label.Font = new Font("Arial", 1, FontStyle.Underline);
            return label;
        }
        private Label LabelExplanation_set_font(Label label)
        {
            label = Default_set(label);
            label.Font = new Font("Arial", 1, FontStyle.Italic);
            return label;
        }
        ...
        public Label LabelDefaultBold_adjust_to_given_positions_and_attach_to_rightXPosition_and_lowerYPostion(Label label, int leftPostion, int rightPosition, int topPosition, int bottomPosition)
        {
            label = LabelDefaultBold_set_font(label);
            float max_fontSize = Max_fontSize_defaultBold;
        ...
        public Label LabelDefaultBold_adjust_to_given_positions_and_attach_to_leftXPosition_and_lowerYPosition(Label label, int leftPostion, int rightPosition, int topPosition, int bottomPosition)
        {
            label = LabelDefaultBold_set_font(label);
            float max_fontSize = Max_fontSize_defaultBold;
            label = Label_adjust_fontSize_to_given_positions(label, leftPostion, rightPosition, topPosition, bottomPosition, max_fontSize);
        ...
        public Label LabelDefaultBold_adjust_to_given_positions_and_attach_to_leftXPosition_and_upperYPosition(Label label, int leftPostion, int rightPosition, int topPosition, int bottomPosition)
        {
            label = LabelDefaultBold_set_font(label);
            float max_fontSize = Max_fontSize_defaultBold;
            label = Label_adjust_fontSize_to_given_positions(label, leftPostion, rightPosition, topPosition, bottomPosition,max_fontSize);
        ...
        public Label LabelExplanation_adjust_to_own_corrected_leftTopBottom_positions_and_attach_to_leftXPosition_and_centerYPosition(Label label, int rightPosition)
        {
            label = LabelExplanation_set_font(label);
            int leftPostion = (int)Math.Round(label.Location.X * Resolution_parameter.X_factor);
            int rightPostion = (int)Math.Round((label.Location.X+label.Width) * Resolution_parameter.X_factor);
            int topPosition = (int)Math.Round(label.Location.Y * Resolution_parameter.Y_factor);
            int bottomPosition = (int)Math.Round((label.Location.Y + label.Height) * Resolution_parameter.Y_factor);
            float max_fontSize = Max_fontSize_explanationText;
            label = Label_adjust_fontSize_to_given_positions(label, leftPostion, rightPosition, topPosition, bottomPosition, max_fontSize);
            label = Label_attach_to_left_x_position(label, leftPostion);
            label = Label_center_y_position(label, topPosition, bottomPosition);
        ...
        private OwnTextBox MyTextBox_adjust_default_parameters_to_existing_coordinates(OwnTextBox myTextBox, int new_height, bool one_line_only)
        {
            ...
            myTextBox.Font = new Font("Arial", 1, FontStyle.Regular);
        ...
        private OwnListBox MyListBox_add_default_parameter_without_changing_coordinates(OwnListBox myListBox, int height_of_one_line)
        {
            ...
            myListBox.Silent_font = new Font("Arial", 1, FontStyle.Regular);
