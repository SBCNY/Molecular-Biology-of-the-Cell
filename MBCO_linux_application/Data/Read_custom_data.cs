...
namespace Data
{
    ...
    class Custom_data_summary_class
    {
        ...
        public void Write(string directory, string fileName, System.Windows.Forms.Label reportLabel, Form1_default_settings_class form_default_settings)
        {
            ...
            ReadWriteClass.WriteData(this.Summaries, custom_data_summary_readWriteOptions, reportLabel, form_default_settings);
        }
    ...
    class User_data_options_class : Options_readWrite_base_class
    {
        ...
        {
            base.Write_entries(writer, typeof(User_data_options_class), "Delete_all_not_significant_genes");
        }
        public override void Add_read_entry_to_options(string readLine)
        {
            base.Add_read_entry(readLine, typeof(User_data_options_class));
        }
    ...
    class Custom_data_writeOptions_class : ReadWriteOptions_base
    {
        public Custom_data_writeOptions_class(string subdirectory, string file_name, bool write_integrationGroup, bool write_timepoints, bool write_entryType)
        {
            ...
            key_propertyNames_list.AddRange(new string[] { "SampleColor_string", "NCBI_official_symbol", "Value_1st", "Value_2nd","Fractional_rank","BgGenes_listName", "Source_fileName", "Significance_status" });
            key_columnNames_list.AddRange(new string[] { "Dataset color", "NCBI official gene symbol", "Value_1st", "Value_2nd","Rank","Background gene list", "Source", "Significant" });
            HeadlineDelimiters = new char[] { Global_class.Tab };
            LineDelimiters = new char[] { Global_class.Tab };
            File_has_headline = true;
            Report = ReadWrite_report_enum.Report_nothing;
    ...
    class Custom_data_class
    {
        ...
        public Custom_data_class()
        {
            ...
            Reset_expBgGenesList_to_default();
        }
            ...
            else
            {
                ...
                for (int indexC = 1; indexC < custom_data_length; indexC++)
                {
                    ...
                    if ((custom_data_line.SampleName.Equals(previous_custom_data_line.SampleName))
                        && (custom_data_line.IntegrationGroup.Equals(previous_custom_data_line.IntegrationGroup))
                ...
                if (timeline_in_log_scale_requested)
                {
                    ...
                    if (timepointsInDays[0]<=0) { submission_allowed = false; }
                }
            }
        ...
        public void Set_missing_results_numbers()
        {
            Custom_data_line_class custom_data_line;
            Custom_data_line_class inner_custom_data_line;
            int custom_data_length = this.Custom_data.Length;
        ...
        public void Set_unique_datasetName_within_whole_custom_data_ignoring_integrationGroups()
        {
            ...
            for (int indexCustom = 0; indexCustom < custom_length; indexCustom++)
            {
                inner_custom_data_line = this.Custom_data[indexCustom];
                uniqueName_sb.Clear();
                uniqueName_sb.AppendFormat(inner_custom_data_line.SampleName);
                if (add_timepoints) { uniqueName_sb.AppendFormat(" - {0} {1}", inner_custom_data_line.Timepoint, inner_custom_data_line.Timeunit); }
                if (add_entryTypes) { uniqueName_sb.AppendFormat(" - {0}", inner_custom_data_line.EntryType); }
        ...
        public void Reset_expBgGenesList_to_default()
        {
        ...
        public Read_error_message_line_class[] Read_and_add_background_genes_and_return_error_messages(string complete_fileName, System.Windows.Forms.Label error_report_label, Form1_default_settings_class form_default_settings)
        {
            ...
            {
                string[] bgGenes = ReadWriteClass.Read_string_array_and_remove_non_letters_from_beginning_and_end_of_each_line(complete_fileName, error_report_label, form_default_settings);
        ...
        public Read_error_message_line_class[] Generate_custom_data_instance_if_no_errors_and_return_error_messages(bool column_for_first_value_specified, Custom_data_readWriteOptions_class readWriteOptions, System.Windows.Forms.Label error_report_label, Form1_default_settings_class form_default_settings)
        {
            Read_error_message_line_class[] read_read_error_messages =  Read_if_no_error_and_return_error_messages(column_for_first_value_specified, readWriteOptions, error_report_label, form_default_settings);
        ...
        private Read_error_message_line_class[] Test_if_all_colors_are_valid(int left_over_error_messages, string complete_fileName)
        {
            ...
            for (int indexRead=0; indexRead< read_lines_length;indexRead++)
            {
                ...
                if (  (!custom_data_line.SampleColor.IsKnownColor)
                    ...
                    && (!considered_wrong_color_dict.ContainsKey(custom_data_line.SampleColor.ToString()))
        ...
        private Read_error_message_line_class[] Read_if_no_error_and_return_error_messages(bool column_for_first_value_specified, Custom_data_readWriteOptions_class readWriteOptions, System.Windows.Forms.Label error_report_label, Form1_default_settings_class form_default_settings)
        {
            ...
            Custom_data_line_class[] read_custom_data = ReadWriteClass.Read_data_fill_array_and_return_error_messages<Custom_data_line_class>(out read_error_messages, readWriteOptions,error_report_label, form_default_settings);
        ...
        public Read_error_message_line_class[] Analyze_if_all_sampleColors_integrationGroups_are_identical_for_each_uniqueFixedDatasetIdentifier_and_geneSymbol(string completeFileName, int max_error_messages_left)
        {
            Set_unique_datasetName_within_whole_custom_data_ignoring_integrationGroups();
            bool consider_integration_groups = this.Get_all_unique_ordered_integrationGroups().Length > 1;
            int custom_data_length = Custom_data.Length;
        ...
        public void Write(string subdirectory, string fileName, System.Windows.Forms.Label reportLabel, Form1_default_settings_class form_default_settings)
        {
            bool writeIntegrationGroups = Get_all_unique_ordered_integrationGroups().Length > 1;
            bool writeEntryType = Get_all_unique_ordered_entryTypes().Length > 1;
            bool writeTimepoint = Get_all_unique_ordered_timepointsInDays().Length > 1;
            ...
            for (int indexCustom=0; indexCustom<custom_data_length;indexCustom++)
            {
                ...
                if ((indexCustom == custom_data_length-1) || (!custom_data_line.Source_fileName.Equals(this.Custom_data[indexCustom + 1].Source_fileName)))
                {
                    ...
                    ReadWriteClass.WriteData(sameSource_custom_data.ToArray(), writeOptions, reportLabel, form_default_settings);
                }
            }
            ...
            for (int indexBg=0; indexBg<bgGenes_lists_array_length;indexBg++)
            {
                ...
                if (!bgGenes_list.Equals(Global_class.Mbco_exp_background_gene_list_name))
                {
                    ...
                    ReadWriteClass.WriteArray(bgGenes, bgGenes_complete_fileName, reportLabel, form_default_settings);
                }
            }
        }
    }
