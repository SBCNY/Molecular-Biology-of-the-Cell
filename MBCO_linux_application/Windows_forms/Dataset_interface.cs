...
namespace ClassLibrary1.Dataset_userInterface
{
    ...
    {
        public static string Input_dataset_sampleName { get { return "Enter sample name"; } }
    ...
    class DatasetSummary_line_class
    {
        ...
        public DatasetSummary_line_class(DatasetSummary_userInterface_line_class userInterface_line)
        {
            this.SampleName = (string)userInterface_line.Dataset_sampleName_textBox.Text.Clone();
            float new_timepoint;
            if (float.TryParse(userInterface_line.Dataset_time_textBox.Text, out new_timepoint))
            ...
            this.Results_no = int.Parse(userInterface_line.Dataset_orderNo_textBox.Text);
            this.Visualize = true;
    ...
    class DatasetSummary_userInterface_line_class
    {
        ...
        private void Set_fore_and_backColors(Color new_foreColor, Color new_backColor)
        {
        ...
        {
            Set_fore_and_backColors(Form_default_settings.Incompatible_dataset_foreColor, Form_default_settings.Incompatible_dataset_backColor);
        }

        public void Set_backcolor_to_flagged_as_marked_for_deletion(Form1_default_settings_class Form_default_settings)
        {
            Set_fore_and_backColors(Form_default_settings.Color_dataset_foreColor_markedForDeletion, Form_default_settings.Color_dataset_backColor_markedForDeletion);
        }

        public void Set_backcolor_to_normal(Form1_default_settings_class Form_default_settings)
        {
            Set_fore_and_backColors(Form_default_settings.Color_dataset_foreColor, Form_default_settings.Color_dataset_backColor);
        }
    }
    ...
    class DatasetSummary_userInterface_class
    {
        ...
        private Label Dataset_compatibility_label { get; set; }
        ...
        public DatasetSummary_userInterface_class(MyPanel overall_interface_panel,
                                                  ...
                                                  Label dataset_compatibility_label,
                                                  ...
                                                  Form1_default_settings_class form_default_settings)
        {
            ...
            this.Dataset_compatibility_label = dataset_compatibility_label;
        ...
        { 
            ...
            Dataset_compatibility_label.Visible = false;
            UserInterface_dataSummaries = new DatasetSummary_line_class[0];
            LastSaved_datasetSummaries = new DatasetSummary_line_class[0];


            int height_of_buttons = (int)Math.Round(0.08F * this.Overall_interface_panel.Height);
            int width_of_buttons = (int)Math.Round(0.15F * this.Overall_interface_panel.Width);
            ...
            Button[] buttons = new Button[] { this.AddNewDataset_button, this.AnalyzeDataset_button, this.ClearDataset_button };// 
            ...
            foreach (Dataset_attributes_enum attribute in attributes)
            {
                ...
                top_referenceBorder = 0;
                bottom_referenceBorder = this.Changes_update_button.Location.Y;
        ...
        private void Initialize_and_set_default_buttons_boxes_and_locations()
        {
            ...
            Dataset_compatibility_label.Location = new Point(start_x_location + x_distance_between_panels + DatasetAttributes_panel_dict[Dataset_attributes_enum.Delete].Width, Dataset_compatibility_label.Location.Y);
        ...
        private void Update_lower_positions_and_visibility_of_buttons_and_panels()
        {
            ...
            int distanceHeight_between_elements = (int)Math.Round(0.01F * Overall_interface_panel.Height);
            int new_lower_y_location_of_panels = lower_y_location_of_last_userInterface_line;
            int new_y_location_for_uncompatible_label = new_lower_y_location_of_panels + distanceHeight_between_elements;
            int dataset_incompatibility_height = (int)Math.Round(0.04F * Overall_interface_panel.Height);
            int new_y_location_for_changes_buttons = new_y_location_for_uncompatible_label + dataset_incompatibility_height + distanceHeight_between_elements;
            #endregion
            ...
            bottom_referenceBorder = Math.Min(AddNewDataset_button.Location.Y - distanceHeight_between_elements,
            ...
            Label my_label = Dataset_compatibility_label;
        ...
        private void Update_datasetCompatibilityDelete_labels_and_description_in_graphical_interface(DatasetSummary_line_class[] dataSummary_lines)
        {
            ...
            if (count_of_datasets_labeled_for_deletion > 0)
            {
                datasetCompatibility_label_is_visible = true;
                Dataset_compatibility_label.BackColor = Form_default_settings.Color_dataset_backColor_markedForDeletion;
                Dataset_compatibility_label.ForeColor = Form_default_settings.Color_dataset_foreColor_markedForDeletion;
                if (count_of_datasets_labeled_for_deletion > 1)
                { Dataset_compatibility_label.Text = count_of_datasets_labeled_for_deletion + " datasets marked for deletion"; }
                else { Dataset_compatibility_label.Text = count_of_datasets_labeled_for_deletion + " dataset marked for deletion"; }
                Dataset_compatibility_label.Refresh();
            ...
            else if (!described_incompatibility.Equals(Dataset_compatibility_enum.Ok))
            {
                ...
                {
                    case Dataset_compatibility_enum.Duplicated_dataset:
                        Dataset_compatibility_label.Text = "Duplicated datasets in same integration group (go to 'Organize data')";
                        break;
                    default:
                        throw new Exception();
                }
                Dataset_compatibility_label.BackColor = Form_default_settings.Incompatible_dataset_backColor;
                Dataset_compatibility_label.ForeColor = Form_default_settings.Incompatible_dataset_foreColor;
                Dataset_compatibility_label.Refresh();
                datasetCompatibility_label_is_visible = true;
            ...
            else if (this.Hidden_userInterface_dataSummaries.Length + this.UserInterface_dataSummaries.Length > Math.Max(0, Last_filled_userInterfaceLines_index))
            {
                ...
                if (datasets_count==1)
                {
                    Dataset_compatibility_label.Text = "List contains " + datasets_count + " dataset";
                }
                else
                {
                    Dataset_compatibility_label.Text = "List contains " + datasets_count + " datasets";
                }
                Dataset_compatibility_label.BackColor = Form_default_settings.Color_dataset_backColor_incompatibilityDelete;
                Dataset_compatibility_label.ForeColor = Form_default_settings.Color_dataset_foreColor_incompatibilityDelete;
                datasetCompatibility_label_is_visible = true;
                Updates_are_allowed_changes_button_allowed_to_be_visible = true;
            }
            else
            ...
            Dataset_compatibility_label.Visible = datasetCompatibility_label_is_visible;
        ...
        private void Copy_current_userInferface_lines_into_related_userInterfaceDatasetSummaries_and_check_for_dataset_incompatibilities()
        {
            ...
            for (int indexUI = 0; indexUI <= Last_filled_userInterfaceLines_index; indexUI++)
            {
                ...
                new_userInterface_datasetSummary_line = new DatasetSummary_line_class(userInterface_line);
                noCompare = -2;
        ...
        {
            DatasetSummary_line_class userInterface_add_dataset = new DatasetSummary_line_class(this.UserInterface_lines[Next_userInterfaceLine_index]);
