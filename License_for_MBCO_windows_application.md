The code for the windows application was written by Jens Hansen working for the Ravi Iyengar Lab (source code has not been not uploaded yet). The copyright holder for code
